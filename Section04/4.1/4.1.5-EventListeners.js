...
document.querySelector("#dog-picture").addEventListener("click", () => alert("this ws clicked."));
...
document.querySelector("body").addEventListener("keydown", event => console.log(`The`) )
